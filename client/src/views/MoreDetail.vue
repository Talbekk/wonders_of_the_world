<template lang="html">
    <div class="background">
      <router-link class="home-button" to="/" tag="button">Go Home</router-link>
...
.background {
    background: url(https://digidezine.com/wp-content/uploads/revslider/agency-sparta-animated1/4-25_mini_mini2.jpg);
    padding-bottom: 50px;
}
